...
public class PlayerInventory extends Inventory
{
	...
	public static int[][] restoreVisibleInventory(int objectId)
	{
		...
		try (Connection con = DatabaseFactory.getConnection())
		{
			PreparedStatement statement = con.prepareStatement("SELECT * FROM skins WHERE playerId = ?");
			...
			if (rs.next())
			{
				...
				if (hairInt != 0)
				{
					Item hair = Item.restoreFromDb(headInt);
					paperdoll[Inventory.PAPERDOLL_HAIR][0] = hair.getObjectId();
					paperdoll[Inventory.PAPERDOLL_HAIR][1] = hair.getItemId();
				}
				if (faceInt != 0)
				{
					Item face = Item.restoreFromDb(headInt);
					paperdoll[Inventory.PAPERDOLL_FACE][0] = face.getObjectId();
					paperdoll[Inventory.PAPERDOLL_FACE][1] = face.getItemId();
				}
				if (headInt != 0)
				{
					Item head = Item.restoreFromDb(headInt);
					paperdoll[Inventory.PAPERDOLL_HEAD][0] = head.getObjectId();
					paperdoll[Inventory.PAPERDOLL_HEAD][1] = head.getItemId();
				}
				if (glovesInt != 0)
				{
					Item gloves = Item.restoreFromDb(glovesInt);
					paperdoll[Inventory.PAPERDOLL_GLOVES][0] = gloves.getObjectId();
					paperdoll[Inventory.PAPERDOLL_GLOVES][1] = gloves.getItemId();
				}
				if (chestInt != 0)
				{
					Item chest = Item.restoreFromDb(chestInt);
					paperdoll[Inventory.PAPERDOLL_CHEST][0] = chest.getObjectId();
					paperdoll[Inventory.PAPERDOLL_CHEST][1] = chest.getItemId();
				}
				if (legsInt != 0)
				{
					Item legs = Item.restoreFromDb(legsInt);
					paperdoll[Inventory.PAPERDOLL_LEGS][0] = legs.getObjectId();
					paperdoll[Inventory.PAPERDOLL_LEGS][1] = legs.getItemId();
				}
				if (feetInt != 0)
				{
					Item feet = Item.restoreFromDb(feetInt);
					paperdoll[Inventory.PAPERDOLL_FEET][0] = feet.getObjectId();
					paperdoll[Inventory.PAPERDOLL_FEET][1] = feet.getItemId();
				}
				if (backInt != 0)
				{
					Item back = Item.restoreFromDb(backInt);
					paperdoll[Inventory.PAPERDOLL_BACK][0] = back.getObjectId();
					paperdoll[Inventory.PAPERDOLL_BACK][1] = back.getItemId();
				}
