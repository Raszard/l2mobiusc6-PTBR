...
public class AutoPlaySettingsHolder
{
	...
	private final AtomicBoolean _respectfulHunting = new AtomicBoolean(false);
	private final AtomicBoolean _limitZone = new AtomicBoolean(false);
	...
	public boolean isLimitZone()
	{
		return _limitZone.get();
	}
	
	public void setLimitZone(boolean value)
	{
		_limitZone.set(value);
	}
