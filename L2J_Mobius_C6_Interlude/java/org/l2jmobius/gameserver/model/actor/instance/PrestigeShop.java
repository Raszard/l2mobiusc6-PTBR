...
public class PrestigeShop extends Folk
{
	public PrestigeShop(int objectId, NpcTemplate template)
	{
	...
	{
		String name = "data/html/alpha/prestige/" + this.getNpcId() + ".htm";
		if (val != 0)
		{
			name = "data/html/alpha/prestige/" + this.getNpcId() + "-" + val + ".htm";
		}
