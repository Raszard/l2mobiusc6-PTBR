...
public class Merchant extends Folk
{
	 ...
	 * @param player the player
	 */
	public void showRentPetWindow(Player player)
	{
		...
		final StringBuilder html1 = new StringBuilder("<html><body>Gerenciador de Pets:<br>");
		html1.append("Você pode alugar um wyvern ou um strider por adenas.<br>Meus preços:<br1>");
		html1.append("<table border=0><tr><td>Montar</td></tr>");
	 ...
	 * @param val the value
	 */
	public void tryRentPet(Player player, int val)
	{
