...
public class SepulcherMonster extends Monster
{
	...
	private class VictimShout implements Runnable
	{
		...
		public void run()
		{
			...
			broadcastPacket(new CreatureSay(getObjectId(), ChatType.GENERAL, getName(), "me perdoe!!"));
		}
	}
	...
	private class VictimSpawnKeyBox implements Runnable
	{
		...
		public void run()
		{
			...
			broadcastPacket(new CreatureSay(getObjectId(), ChatType.GENERAL, getName(), "Muito obrigado por me resgatar."));
		}
	}
