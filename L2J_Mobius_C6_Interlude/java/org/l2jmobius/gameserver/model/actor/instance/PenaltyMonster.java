...
public class PenaltyMonster extends Monster
{
	...
	public void setPlayerToKill(Player ptk)
	{
		if (Rnd.get(100) <= 80)
		{
			broadcastPacket(new CreatureSay(getObjectId(), ChatType.GENERAL, getName(), "mmm sua isca estava deliciosa"));
		}
		_ptk = ptk;
	...
	public boolean doDie(Creature killer)
	{
		...
		if (Rnd.get(100) <= 75)
		{
			broadcastPacket(new CreatureSay(getObjectId(), ChatType.GENERAL, getName(), "Eu direi aos peixes para não morderem sua isca"));
		}
		return true;
	}
