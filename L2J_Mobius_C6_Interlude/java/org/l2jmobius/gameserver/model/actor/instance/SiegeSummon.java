...
public class SiegeSummon extends Servitor
{
	...
	public SiegeSummon(int objectId, NpcTemplate template, Player owner, Skill skill)
	{
	...
	public void onSpawn()
	{
		...
		{
			unSummon(getOwner());
			getOwner().sendMessage("Invocação foi desinvocada porque saiu da zona de cerco");
		}
	}
}
