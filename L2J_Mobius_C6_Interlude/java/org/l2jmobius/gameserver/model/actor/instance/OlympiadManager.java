		...
		else if (command.startsWith("OlympiadNoble"))
		{
			...
			switch (val)
			{
				...
				case 2:
				{
					...
					replyMSG.append("O número de pessoas na lista de espera para a Grande Olimpíada<center><img src=\"L2UI.SquareWhite\" width=270 height=1><img src=\"L2UI.SquareBlank\" width=1 height=3><table width=270 border=0 bgcolor=\"000000\"><tr><td align=\"left\">Em Geral</td><td align=\"right\">" + classed + "</td></tr><tr><td align=\"left\">Não definido por classe</td><td align=\"right\">" + nonClassed + "</td></tr></table><br><img src=\"L2UI.SquareWhite\" width=270 height=1> <img src=\"L2UI.SquareBlank\" width=1 height=3><button value=\"Voltar\" action=\"bypass -h npc_" + getObjectId() + "_OlympiadDesc 2a\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center>");
				...
				case 3:
				{
					...
					if (points >= 0)
					{
						reply = new NpcHtmlMessage(getObjectId());
						replyMSG = new StringBuilder("<html><body>");
						replyMSG.append("Há " + points + " Pontos da Grande Olimpíada concedidos para este evento.<br><br><a action=\"bypass -h npc_" + getObjectId() + "_OlympiadDesc 2a\">Voltar</a>");
						replyMSG.append("</body></html>");
						reply.setHtml(replyMSG.toString());
						player.sendPacket(reply);
					}
				...
				case 4:
				{
					...
					{
						player.sendMessage("Você já está registrado em um evento.");
						return;
					}
				...
				case 6:
				{
					...
					{
						player.sendMessage("Não há pontos suficientes ou não está no período de validação");
		...
		else if (command.startsWith("Olympiad"))
		{
			...
			switch (val)
			{
				case 1:
				{
					...
					replyMSG.append("Visão geral dos jogos da Grande Olimpíada<br><br>* Cuidado: Observe que, se você assistir a um jogo da Olimpíada, a convocação de seus servos ou pets será cancelada. Tome cuidado.<br>");
				...
				case 2:
				{
					...
					if (classId >= 88)
					{
						replyMSG.append("<center>Classificação da Grande Olimpíada");
