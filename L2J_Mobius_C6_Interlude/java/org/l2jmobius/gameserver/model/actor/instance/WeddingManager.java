...
public class WeddingManager extends Npc
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("AcceptWedding"))
		{
			...
			player.sendMessage("Parabéns, vocês estão casados!");
			player.setMarried(true);
			player.setMaryRequest(false);
			player.setmarriedType(type);
			ptarget.sendMessage("Parabéns, vocês estão casados!");
			...
			{
				AnnouncementsTable.getInstance().announceToAll("Parabéns a " + player.getName() + " e " + ptarget.getName() + "! Eles se casaram.");
			}
		...
		else if (command.startsWith("DeclineWedding"))
		{
			...
			player.sendMessage("Você recusou");
			ptarget.sendMessage("Seu parceiro recusou");
			replace = ptarget.getName();
