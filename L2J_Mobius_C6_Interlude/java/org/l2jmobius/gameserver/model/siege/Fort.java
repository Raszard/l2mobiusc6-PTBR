...
public class Fort
{
	...
	public void setOwner(Clan clan)
	{
		...
		if ((_ownerId > 0) && ((clan == null) || (clan.getClanId() != _ownerId)))
		{
			...
			if (oldOwner != null)
			{
				...
				AnnouncementsTable.getInstance().announceToAll(oldOwner.getName() + " perdeu a fortaleza de " + getName() + "!");
			}
		}
	...
	public void removeOwner(Clan clan)
	{
		if (clan != null)
		{
			_formerOwner = clan;
			clan.setHasFort(0);
			AnnouncementsTable.getInstance().announceToAll(clan.getName() + " perdeu o forte de " + getName() + "!");
	...
	public void setTaxPercent(Player player, int taxPercent)
	{
		...
		player.sendMessage("O imposto do forte " + _name + " foi alterado para" + taxPercent + "%.");
	}
	...
	private void updateOwnerInDB(Clan clan)
	{
		...
		try (Connection con = DatabaseFactory.getConnection())
		{
			...
			if (clan != null)
			{
				...
				AnnouncementsTable.getInstance().announceToAll(clan.getName() + " tomou o forte de " + getName() + "!");
				clan.broadcastToOnlineMembers(new PledgeShowInfoUpdate(clan));
