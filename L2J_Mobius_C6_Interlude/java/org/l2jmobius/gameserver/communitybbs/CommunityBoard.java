...
import org.l2jmobius.gameserver.communitybbs.Manager.AuctionBBSManager;
...
import org.l2jmobius.gameserver.communitybbs.Manager.InfoBBSManager;
...
public class CommunityBoard
{
	...
	public void handleCommands(GameClient client, String command)
	{
		...
		{
			AuctionBBSManager.getInstance().parseCmd(command.substring(12), player);
		}
