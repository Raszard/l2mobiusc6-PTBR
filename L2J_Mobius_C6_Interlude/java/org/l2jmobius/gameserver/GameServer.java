...
import org.l2jmobius.gameserver.donation.DonationTaskManager;
	...
	public GameServer() throws Exception
	{
		...
		if (Config.DEADLOCK_DETECTOR)
		{
			final DeadLockDetector deadDetectThread = new DeadLockDetector(Duration.ofSeconds(Config.DEADLOCK_CHECK_INTERVAL), () ->
			{
				...
				{
					AnnouncementsTable.getInstance().announceToAll("O servidor está com problemas de estabilidade - reiniciando agora.");
