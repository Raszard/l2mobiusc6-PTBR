...
public class RequestJoinParty implements ClientPacket
{
	...
	public void run(GameClient client)
	{
		...
		{
			requestor.sendMessage("Você não pode convidar o GM no modo invisível.");
			return;
		}
		
		if (target.isInJail() || requestor.isInJail())
		{
			final SystemMessage sm = SystemMessage.sendString("O jogador está na prisão.");
		...
		{
			requestor.sendMessage("Você não pode convidar um jogador quando estiver no Dimensional Rift.");
		}
		else
		{
