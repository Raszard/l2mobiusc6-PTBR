...
public class CharacterCreate implements ClientPacket
{
	...
	private void initNewChar(GameClient client, Player newChar)
	{
		...
		if (Config.CUSTOM_STARTER_ITEMS_ENABLED)
		{
			...
			{
				case HUMAN:
					newChar.getInventory().addItem("Starter Scrolls", 7117, 10, newChar, null);
					break;
				case ELF:
					newChar.getInventory().addItem("Starter Scrolls", 7118, 10, newChar, null);
					break;
				case DARK_ELF:
					newChar.getInventory().addItem("Starter Scrolls", 7119, 10, newChar, null);
					break;
				case ORC:
					newChar.getInventory().addItem("Starter Scrolls", 7120, 10, newChar, null);
					break;
				case DWARF:
					newChar.getInventory().addItem("Starter Scrolls", 7121, 10, newChar, null);
					break;
				default:
