...
public class RequestAquireSkill implements ClientPacket
{
	...
	public void run(GameClient client)
	{
		...
		if (_skillType == 0)
		{
			...
			{
				player.sendMessage("Você está tentando aprender uma habilidade que não consegue...");
		...
		else if (_skillType == 2) // pledgeskills TODO: Find appropriate system messages.
		{
			if (!player.isClanLeader())
			{
				...
				player.sendMessage("Este recurso está disponível apenas para o líder do clã");
				return;
			}
