...
public class RequestRestart implements ClientPacket
{
	...
	public void run(GameClient client)
	{
		...
		{
			player.sendMessage("Não é possível reiniciar durante a negociação.");
			player.sendPacket(RestartResponse.valueOf(false));
			return;
		}
		...
		{
			player.sendMessage("Você não pode reiniciar enquanto estiver na Olimpíada.");
			player.sendPacket(RestartResponse.valueOf(false));
			return;
		}
		...
		if (player.isFestivalParticipant())
		{
			...
			{
				player.sendPacket(SystemMessage.sendString("Você não pode reiniciar enquanto estiver participando de um festival."));
		...
		{
			player.sendMessage("Você não pode reiniciar enquanto estiver registrado em um evento.");
			player.sendPacket(RestartResponse.valueOf(false));
			return;
		}
