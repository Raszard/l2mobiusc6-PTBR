...
public class SendWareHouseWithDrawList implements ClientPacket
{
	...
	public void run(GameClient client)
	{
		...
		{
			player.sendMessage("Você está retirando itens muito rápido.");
			return;
		}
		...
		{
			player.sendMessage("Você não pode retirar itens quando estiver negociando.");
		...
		for (int i = 0; i < _count; i++)
		{
			...
			{
				player.sendMessage("Não é possível retirar o itemsolicitado");
			}
