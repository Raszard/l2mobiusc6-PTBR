...
public class RequestPrivateStoreManageSell implements ClientPacket
{
	...
	public void run(GameClient client)
	{
		...
		{
			player.sendMessage("Loja privada desabilitada pela GM nas configurações!");
		...
		if (player.getPrivateStoreType() == Player.STORE_PRIVATE_NONE)
		{
			...
			{
				player.sendPacket(new CreatureSay(0, ChatType.PARTYROOM_COMMANDER, "", "ATENÇÃO: O Store System não é baseado em Adena, tenha cuidado!"));
			}
