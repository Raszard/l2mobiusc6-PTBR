...
public class Shutdown extends Thread
{
	...
	public void startShutdown(Player player, int seconds, boolean restart)
	{
		...
		if (_shutdownMode > 0)
		{
			announcements.announceToAll("Servidor será " + MODE_TEXT[_shutdownMode] + " em " + seconds + " segundos!");
			announcements.announceToAll("Por favor, saia do jogo agora!!");
		}
	...
	public void abort(Player player)
	{
		...
		announcements.announceToAll("Servidor será" + MODE_TEXT[_shutdownMode] + " e continuará a operação normal!");
	...
	private synchronized void saveData()
	{
		...
		try
		{
			announcements.announceToAll("Servidor será " + MODE_TEXT[_shutdownMode] + " AGORA!");
		}
		catch (Throwable t)
		{
		}
