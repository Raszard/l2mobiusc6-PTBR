...
public class ScrollOfResurrection implements IItemHandler
{
	...
	public void useItem(Playable playable, Item item)
	{
		...
		{
			player.sendMessage("Este item não pode ser usado em jogos de Olimpíadas.");
		}
		...
		if ((target != null) && target.isDead())
		{
			...
			if ((targetPlayer != null) || (targetPet != null))
			{
				...
				if (targetPet != null)
				{
					...
					{
						condGood = false;
						player.sendMessage("Você não tem o pergaminho correto");
					}
				}
				else if (targetPlayer != null)
				{
					...
					{
						condGood = false;
						player.sendPacket(SystemMessage.sendString("Você não pode ressuscitar participantes de um festival."));
					}
