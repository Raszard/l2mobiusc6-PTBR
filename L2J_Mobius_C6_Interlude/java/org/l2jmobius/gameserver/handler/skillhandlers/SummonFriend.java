...
public class SummonFriend implements ISkillHandler
{
	...
	public void useSkill(Creature creature, Skill skill, List<Creature> targets)
	{
		...
		{
			activePlayer.sendMessage("Você não pode usar esta habilidade em um Evento.");
			return;
		}
		...
		{
			activePlayer.sendMessage("Você não pode invocar em uma zona de cerco.");
			return;
		}
		...
		try
		{
			for (WorldObject wo : targets)
			{
				...
				if (target instanceof Player)
				{
					...
					{
						activePlayer.sendMessage("Seu alvo não pode ser invocado enquanto não tiver um Cristal de Invocação.");
						targetPlayer.sendMessage("Você não pode ser invocado enquanto não tiver um Cristal de Invocação.");
						continue;
					}
