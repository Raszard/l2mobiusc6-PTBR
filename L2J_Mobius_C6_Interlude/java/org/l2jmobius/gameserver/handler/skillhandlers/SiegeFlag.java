...
public class SiegeFlag implements ISkillHandler
{
	...
	public void useSkill(Creature creature, Skill skill, List<Creature> targets)
	{
		...
		{
			player.sendMessage("Erro ao colocar a bandeira:" + e);
		}
	}
	...
	public static boolean checkIfOkToPlaceFlag(Creature creature, Castle castle, boolean isCheckOnly)
	{
		...
		{
			message = "Você deve estar no terreno do castelo para colocar uma bandeira.";
		}
		else if (!castle.getSiege().isInProgress())
		{
			message = "Você só pode colocar uma bandeira durante um cerco.";
		}
		else if (castle.getSiege().getAttackerClan(player.getClan()) == null)
		{
			message = "Você deve ser um atacante para colocar uma bandeira.";
		}
		else if ((player.getClan() == null) || !player.isClanLeader())
		{
			message = "Você deve ser um líder de clã para colocar uma bandeira.";
		}
		else if (castle.getSiege().getAttackerClan(player.getClan()).getNumFlags() >= SiegeManager.getInstance().getFlagMaxCount())
		{
			message = "Você já colocou o número máximo de bandeiras possível.";
		}
		else if (!player.isInsideZone(ZoneId.HQ))
		{
			message = "Você não pode colocar uma bandeira aqui.";
		}
		else
		{
			return true;
	...
	public static boolean checkIfOkToPlaceFlag(Creature creature, Fort fort, boolean isCheckOnly)
	{
		...
		{
			message = "Você deve estar no terreno do forte para colocar uma bandeira.";
		}
