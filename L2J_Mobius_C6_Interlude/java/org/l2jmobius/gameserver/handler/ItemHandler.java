...
import org.l2jmobius.gameserver.handler.itemhandlers.Donator;
...
import org.l2jmobius.gameserver.handler.itemhandlers.MirrorOfTruth;
...
import org.l2jmobius.gameserver.handler.itemhandlers.ScrollOfWisdom;
...
import org.l2jmobius.gameserver.handler.itemhandlers.Wikia;
...
public class ItemHandler
{
	...
	protected ItemHandler()
	{
		...
		registerItemHandler(new Donator());
		registerItemHandler(new Wikia());
		registerItemHandler(new MirrorOfTruth());
		registerItemHandler(new ScrollOfWisdom());
