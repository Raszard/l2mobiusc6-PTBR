						...
						else if ((qs1.getInt("step") == 1) && (qs2.getInt("Ex") <= 2) && (qs1.getQuestItemsCount(item) == 0))
						{
							if (qs1.hasAtLeastOneQuestItem(BLUE_GEM))
							{
								...
								if (isMage && !isOrcMage)
								{
									...
									{
										htmltext = "<html><body>Sinto muito. Eu só ajudo Fighters. Por favor, procure outro ajudante novato que possa ajudá-lo.</body></html>";
									}
								}
								else
								{
									...
									if (htmltext.equalsIgnoreCase(""))
									{
										htmltext = "<html><body>Sinto muito. Eu só ajudo Mystics. Por favor, procure outro ajudante novato que possa ajudá-lo.</body></html>";
									}
								}
							}
							else
