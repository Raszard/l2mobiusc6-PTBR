	...
	{
		{
			...
			"Você quer me domar, hein?",
			"Não me dê isso. Talvez você esteja em perigo.",
			"Bah bah. O que é essa coisa desagradável?",
			"Minha barriga está reclamando. Isso acertou em cheio.",
			"O que é isso? Posso comer?",
			"Você não precisa se preocupar comigo.",
			"Comida deliciosa, obrigado.",
			"Estou começando a gostar de você!",
			"Gole!"
		},
		{
			"Eu não acho que você tenha desistido da ideia de me domesticar.",
			"Isso é apenas comida para mim. Talvez eu possa comer sua mão também.",
			"Comer isso vai me deixar gordo? Ha ha.",
			"Por que você sempre me alimenta?",
			"Não confie em mim. Posso traí-lo."
		},
		{
			"Destruir!",
			"Olha o que você fez!",
			"Sentimento estranho...! Más intenções crescem em meu coração...!",
			"Está acontecendo!",
			"Isso é triste...Bom é triste...!"
		}
	};
	
	private static final String[] SPAWN_CHATS =
	{
		"$s1, você pode me mostrar seu esconderijo?",
		"$s1, sempre que olho para especiarias, penso em você.",
		"$s1, você não precisa voltar para a aldeia. Eu te darei forças.",
		"Obrigado, $s1. Espero poder ajudá-lo.",
		"$s1, o que posso fazer para ajudá-lo?",
	};
