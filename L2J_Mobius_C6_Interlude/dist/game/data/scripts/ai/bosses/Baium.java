...
public class Baium extends Quest
{
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		if (_zone == null)
		{
			return "<html><body>Vórtice Angelical:<br>Você não pode entrar enquanto o administrador desativou esta zona</body></html>";
		}
		...
		if ((npcId == STONE_BAIUM) && (status == ASLEEP))
		{
			...
			{
				htmltext = "As condições não são adequadas para acordar Baium.";
			}
		}
		else if (npcId == ANGELIC_VORTEX)
		{
			if (player.isFlying())
			{
				return "<html><body>Vórtice Angelical:<br>Você não pode entrar enquanto monta um wyvern.</body></html>";
			}
