...
public class Benom extends Quest
{
	...
	private static final String[] TALK =
	{
		...
		"Ainda não terminei aqui, venha me encarar!!!",
		"Seus covardes!!! Vou torturar cada um de vocês!!!"
	};
	...
	public String onFirstTalk(Npc npc, Player player)
	{
		...
		if ((castleOwner > 0) && (clanId > 0))
		{
			...
			return "<html><body>Avatar de Benom:<br>Seu clã não possui este castelo. Somente membros do clã proprietário deste castelo podem desafiar Benom.</body></html>";
		}
		return "<html><body>Avatar de Benom:<br>Seu clã não possui este castelo. Somente membros do clã proprietário deste castelo podem desafiar Benom.</body></html>";
	}
