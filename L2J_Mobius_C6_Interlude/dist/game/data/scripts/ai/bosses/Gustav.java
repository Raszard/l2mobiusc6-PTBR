...
public class Gustav extends Quest
{
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		for (Clan clan : _clans)
		{
			if (clan == playerClan)
			{
				return "<html><body>Você já se inscreveu!</body></html>";
			}
		}
		...
		if (DevastatedCastle.getInstance().Conditions(player))
		{
			...
			return "<html><body>Você se registrou com sucesso em um cerco.</body></html>";
		}
		
		return "<html><body>Você não tem permissão para fazer isso!</body></html>";
	}
