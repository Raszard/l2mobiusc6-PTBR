	...
	public String onTalk(Npc npc, Player player)
	{
		if (player.getInventory().getItemByItemId(STONE) != null)
		{
			if (!GlobalVariablesManager.getInstance().hasVariable("SailrenClose"))
			{
				...
				{
					return "<html><body><font color=LEVEL>Só com Grupo...</font></body></html>";
				}
			}
			else
			{
				return "<html><body><font color=LEVEL>Tem mais alguém lá dentro...</font></body></html>";
			}
		}
		else
		{
			return "<html><body>Você precisa do item de missão: <font color=LEVEL>Gazkh...</font></body></html>";
		}
		return null;
	}
