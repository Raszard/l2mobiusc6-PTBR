...
public class Q022_TragedyInVonHellmannForest extends Quest
{
	...
	{
		super(22, "Tragédia na Floresta Von Hellmann");
		addKillId(MOBS);
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			case "31334-13.htm":
			{
				...
				if (((5 <= cond) && (cond <= 7)) && qs.hasQuestItems(CROSS_OF_EINHASAD))
				{
					if (_tifarenOwner == 0)
					{
						...
						ghost2.broadcastNpcSay("Você me ligou? " + player.getName() + "?");
			...
			case "DESPAWN_GHOST2":
			{
				...
				{
					npc.broadcastNpcSay("ESTOU_CONFUSO_TALVEZ_SEJA_HORA_DE_VOLTAR");
				}
				npc.deleteMe();
				break;
			}
