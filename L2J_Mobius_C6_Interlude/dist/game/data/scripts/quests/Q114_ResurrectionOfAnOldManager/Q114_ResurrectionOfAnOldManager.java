...
public class Q114_ResurrectionOfAnOldManager extends Quest
{
	...
	{
		super(114, "Ressurreição de um Antigo Gerente");
		...
		switch (event)
		{
			...
			case "32047-15a.htm":
			{
				if (st.getInt("golemSpawned") == 0)
				{
					...
					golem.broadcastNpcSay("Você, " + player.getName() + ", você atacou Wendy. Prepare-se para morrer!");
				...
				switch (npc.getNpcId())
				{
					...
					case STONE:
					{
						if (cond == 17)
						{
							...
							player.sendPacket(new ExShowScreenMessage("O detector de sinal de rádio está respondendo. # Uma pilha suspeita de pedras chama sua atenção.", 4500));
							return null;
						}
						else if (cond == 18)
						{
	...
	public String onKill(Npc npc, Player player, boolean isPet)
	{
		...
		npc.broadcastNpcSay("Este inimigo é poderoso demais para eu lutar. Devo me retirar!");
		st.setCond(11);
		st.unset("golemSpawned");
		st.playSound(QuestState.SOUND_MIDDLE);
