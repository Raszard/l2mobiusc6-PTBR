	...
	public String onKill(Npc npc, Player player, boolean isPet)
	{
		...
		switch (npc.getNpcId())
		{
			...
			case 20580:
			{
				...
				{
					npc.broadcastNpcSay("Se os ovos forem roubados, estamos mortos!");
				}
				break;
			}
			case 20233:
			...
			case 20551:
			{
				...
				{
					npc.broadcastNpcSay("Ei! Todo mundo cuida dos ovos!");
				}
				break;
			}
			case 20270:
			{
				...
				{
					npc.broadcastNpcSay("Achei que tinha pegado uma ação... Ufa!");
				}
				break;
			}
			case 20202:
			...
			case 20599:
			{
				if (st.hasQuestItems(DELUXE_FAIRY_STONE) && (getRandom(100) < 30))
				{
					st.set("deluxestone", "2");
					st.playSound(QuestState.SOUND_MIDDLE);
					st.takeItems(DELUXE_FAIRY_STONE, 1);
					npc.broadcastNpcSay("A pedra... a pedra élfica... quebrou...");
				}
				break;
			}
		}
