...
public class Q616_MagicalPowerOfFire_Part2 extends Quest
{
	...
	{
		super(616, "Poder Mágico do Fogo - Parte II");
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			final RaidBoss raid = RaidBossSpawnManager.getInstance().getBosses().get(SOUL_OF_FIRE_NASTRON);
	...
	private boolean spawnRaid()
	{
		...
		if ((raid != null) && (raid.getRaidStatus() == RaidBossStatus.ALIVE))
		{
			...
			raid.broadcastNpcSay("O fogo que você acende para o seu inimigo muitas vezes queima mais você do que ele.");
