...
public class Q002_WhatWomenWant extends Quest
{
	...
	private static List<Race> RACES = Arrays.asList(Race.ELF, Race.HUMAN);
	
	public Q002_WhatWomenWant()
	{
		super(2, "O que as Mulheres Querem");
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		switch (st.getState())
		{
			case State.CREATED:
			{
				...
				/*
				 * if ((player.getRace() != Race.ELF) && (player.getRace() != Race.HUMAN)) { htmltext = "30223-00.htm"; }
				 */
