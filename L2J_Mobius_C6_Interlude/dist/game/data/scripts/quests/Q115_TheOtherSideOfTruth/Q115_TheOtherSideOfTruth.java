...
public class Q115_TheOtherSideOfTruth extends Quest
{
	...
	{
		super(115, "O Outro Lado da Verdade");
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			case "32022-02.htm":
			{
				...
				man.broadcastPacket(new CreatureSay(man.getObjectId(), ChatType.GENERAL, man.getName(), "Nos encontramos novamente."));
			...
			case "Sculpture-04a.htm":
			{
				...
				man.broadcastPacket(new CreatureSay(man.getObjectId(), ChatType.GENERAL, man.getName(), "Este parece ser o lugar certo..."));
			...
			case "1":
			{
				npc.broadcastPacket(new CreatureSay(npc.getObjectId(), ChatType.GENERAL, npc.getName(), "Eu vejo alguém. Isso é o destino?"));
				break;
			}
			case "2":
			{
