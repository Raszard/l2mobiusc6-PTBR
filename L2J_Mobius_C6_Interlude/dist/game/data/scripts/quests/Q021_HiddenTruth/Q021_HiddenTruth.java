...
public class Q021_HiddenTruth extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			{
				st.set("end_walk", "1");
				_page.broadcastNpcSay("Por favor, verifique esta estante, " + player.getName() + ".");
				startQuestTimer("5", 47000, _page, player, false);
				return null;
			}
			case "5":
			{
				_page.broadcastNpcSay("Estou confuso! Talvez seja hora de voltar.");
				return null;
			}
			case "31328-05.htm":
			{
	...
	private void spawnTheDuke(Player player)
	{
		if (_duke == null)
		{
			...
			_duke.broadcastNpcSay("Quem me acordou?");
	...
	private void spawnThePage(Player player)
	{
		if (_page == null)
		{
			...
			_page.broadcastNpcSay("Meu mestre me instruiu para ser seu guia, " + player.getName() + ".");
