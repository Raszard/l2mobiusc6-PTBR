...
public class Q609_MagicalPowerOfWater_Part1 extends Quest
{
	...
	{
		super(609, "Poder Mágico da Água - Parte I");
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			{
				npc.broadcastNpcSay("Aguardo seu retorno.");
				return null;
			}
		}
	...
	public String onAggro(Npc npc, Player player, boolean isPet)
	{
		...
		if (st.isCond(2) && (st.getInt("spawned") == 0))
		{
			...
			// Spawn Asefa's eye.
			final Npc asefaEye = addSpawn(EYE, player, true, 10000);
			if (asefaEye != null)
			{
				startQuestTimer("AsefaEyeDespawn", 9000, asefaEye, player, false);
				asefaEye.broadcastNpcSay("Você não pode escapar do Olho de Asefa!");
