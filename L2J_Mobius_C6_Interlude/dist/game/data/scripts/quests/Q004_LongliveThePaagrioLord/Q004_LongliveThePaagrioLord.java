...
public class Q004_LongliveThePaagrioLord extends Quest
{
	...
	private static List<Race> RACES = Arrays.asList(Race.ORC);
	
	public Q004_LongliveThePaagrioLord()
	{
		super(4, "Viva o Senhor Pa'Agrio!");
		registerQuestItems(1541, 1542, 1543, 1544, 1545, 1546);
		addStartNpc(30578); // Nakusin
		addTalkId(30578, 30566, 30585, 30562, 30560, 30559, 30587);
	}
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		switch (st.getState())
		{
			case State.CREATED:
			{
				if (!RACES.contains(player.getRace()))
				{
				...
				else
				{
					...
					if (st.hasQuestItems(i))
					{
						switch (npcId)
						{
							...
							case 30562:
							{
								htmltext = "30562-02.htm";
								break;
							}
							case 30560:
							{
								htmltext = "30560-02.htm";
								break;
							}
							case 30559:
							{
								htmltext = "30559-02.htm";
								break;
							}
							case 30587:
							{
