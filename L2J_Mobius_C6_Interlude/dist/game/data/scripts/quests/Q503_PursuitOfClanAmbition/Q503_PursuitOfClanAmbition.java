...
public class Q503_PursuitOfClanAmbition extends Quest
{
	...
	{
		super(503, "Em Busca da Ambição do Clã!");
				...
				if (st.getCond() == cond)
				{
					...
					else
					{
						if (element[0] == IMPERIAL_GRAVEKEEPER)
						{
							...
							coffer.broadcastNpcSay("Maldição dos deuses sobre aquele que profanar a propriedade do império!");
						}
