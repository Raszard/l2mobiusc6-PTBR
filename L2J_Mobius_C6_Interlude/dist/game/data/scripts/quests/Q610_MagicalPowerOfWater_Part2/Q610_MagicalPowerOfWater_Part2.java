...
public class Q610_MagicalPowerOfWater_Part2 extends Quest
{
	...
	{
		super(610, "Poder Mágico da Água - Parte II");
	...
	private boolean spawnRaid()
	{
		...
		if ((raid != null) && (raid.getRaidStatus() == RaidBossStatus.ALIVE))
		{
			...
			raid.broadcastNpcSay("Você não veio a este mundo. Você saiu dele, como uma onda do oceano. Você não é um estranho aqui.");
