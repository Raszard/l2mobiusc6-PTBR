		...
		if (cond == 3)
		{
			switch (npc.getNpcId())
			{
				case SINGING_FLOWER_PHANTASM:
				{
					...
					{
						npc.broadcastNpcSay("Eu sou uma árvore do nada... uma árvore... que sabe para onde voltar...");
				...
				case SINGING_FLOWER_NIGHTMARE:
				{
					...
					{
						npc.broadcastNpcSay("Eu sou uma criatura que mostra a verdade do lugar no fundo do meu coração...");
				...
				case SINGING_FLOWER_DARKLING:
				{
					...
					{
						npc.broadcastNpcSay("Eu sou um espelho da escuridão... uma imagem virtual da escuridão...");
