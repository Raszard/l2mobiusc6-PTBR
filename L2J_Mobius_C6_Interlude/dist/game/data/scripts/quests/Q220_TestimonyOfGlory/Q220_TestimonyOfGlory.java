...
public class Q220_TestimonyOfGlory extends Quest
{
	...
	{
		super(220, "Testemunho de Glória");
	...
	public String onAttack(Npc npc, Player attacker, int damage, boolean isPet)
	{
		...
		switch (npc.getNpcId())
		{
			...
			case RAGNA_ORC_SEER:
			{
				...
				{
					npc.broadcastNpcSay("É um lacaio do Kakai?!");
			...
			case REVENANT_OF_TANTOS_CHIEF:
			{
				if (st.isCond(9))
				{
					...
					{
						npc.broadcastNpcSay("Que lamentável! Desonra injusta!");
						npc.setScriptValue(1);
					}
					else if (npc.isScriptValue(1) && ((npc.getCurrentHp() / npc.getMaxHp()) < 0.33))
					{
						npc.broadcastNpcSay("Morte indignada e injusta!");
